...
public class BLDOrderBuilder implements OrderBuilder {
    ...
    public BLDOrderBuilder(@JsonProperty("year") int year,
    ...
    public OrderCommitment construct(Game game) {
        return new OrderCommitment(year, phase, new BLDOrder(game.getPower(power), game.getRegion(region)));
    }
    ...
    public boolean equals(Object o) {
        ...
        BLDOrderBuilder that = (BLDOrderBuilder) o;
